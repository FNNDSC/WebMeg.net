 ...
 * type  : 1 for absolute and 0 for true 
 ...
 */
 ...
 /* Function to multiply the array by a number 
  * Inputs : 
  * s : array to be multiplied
  * num: number to multiply the array
  */
 
 function mulArr(data,val) {
	 if (data[0].length==undefined) {
	    	for (var i=0;i<data.length;i++) data[i]=data[i]*val;
	    }
	    else {
